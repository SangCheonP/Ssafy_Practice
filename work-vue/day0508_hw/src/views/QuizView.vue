<script setup>
import { ref } from "vue";
import QuizDetailVue from "@/views/QuizDetail.vue";
...
const quizzes = ref([
  ...
  },
  {
    pk: 5,
    question:
      "웹 애플리케이션을 개발할 때, 사용자의 브라우저에 보여지는 부분을 랜더링하는 언어는 무엇인가요?",
    answer: "html",
  },
]);
</script>
...
<template>
  <div>
    <div v-for="quiz in quizzes" :key="quiz.pk">
      <QuizDetailVue :quiz="quiz" />
    </div>
  </div>
</template>
